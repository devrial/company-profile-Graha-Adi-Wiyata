...
const Service = () => {
  return (
    ...
    <div className="p-mt-4 surface-0 text-center">
      ...
      <div className="grid">
        <div className="col-12 md:col-4 mb-4 px-5">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-desktop icon-style text-4xl text-blue-500"></i>
          </span>
        ...
        <div className="col-12 md:col-4 mb-4 px-5">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-lock icon-style text-4xl text-blue-500"></i>
          </span>
        ...
        <div className="col-12 md:col-4 mb-4 px-5">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-check-circle icon-style text-4xl text-blue-500"></i>
          </span>
        ...
        <div className="col-12 md:col-4 mb-4 px-5">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-globe icon-style text-4xl text-blue-500"></i>
          </span>
        ...
        <div className="col-12 md:col-4 mb-4 px-5">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-github icon-style text-4xl text-blue-500"></i>
          </span>
        ...
        <div className="col-12 md:col-4 md:mb-4 mb-0 px-3">
          <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
            <i className="pi pi-shield icon-style text-4xl text-blue-500"></i>
          </span>
